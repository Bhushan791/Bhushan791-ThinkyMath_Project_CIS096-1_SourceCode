...
//
//    private Home home;
//    private String teacherName = "Sandhya Chaudhary";
...
//    }
//
//    // ... [Keep header, sidebar, and other methods unchanged] ...
//
//
//
...
//            -fx-border-radius: 15;
//            -fx-border-width: 1;
//            -fx-table-header-background: #f8f8f8;
//            -fx-table-header-border-color: #e0e0e0;
//            -fx-table-header-border-width: 0 0 1 0;
//            -fx-table-row-cell: even-row;
//            -fx-table-row-cell: odd-row;
//            """);
//
...
//        });
//
//        TableColumn<StudentPerformance, String> dateCol = new TableColumn<>("Completion Date");
//        dateCol.setCellValueFactory(new PropertyValueFactory<>("completionDate"));
//        dateCol.setPrefWidth(150);
//
//        table.getColumns().addAll(testIdCol, studentIdCol, testNameCol, studentNameCol, scoreCol, dateCol);
//
//        ObservableList<StudentPerformance> data = FXCollections.observableArrayList(
//                new StudentPerformance("1", "1", "Math Basics", "Bhushan Bhatta", "100", "2025-03-27"),
//                new StudentPerformance("2", "2", "Algebra Fundamentals", "Priyanka", "75", "2025-03-25"),
//                new StudentPerformance("3", "3", "Geometry Mastery", "Rahul", "85", "2025-03-24"),
//                new StudentPerformance("4", "4", "Advanced Calculus", "Aisha", "90", "2025-03-23")
//        );
//
//        table.setItems(data);
